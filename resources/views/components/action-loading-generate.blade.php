<div >
    ...
    <div wire:loading wire:target="generateTeams">
        <div class="m-0 rounded-md flex justify-center items-center bg-gray-700 absolute z-40 w-full
        h-full opacity-75 px-5">
