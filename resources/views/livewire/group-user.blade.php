        ...
        <div class="stats shadow">
            <a wire:click="showGroupModal(2)" class="cursor-pointer">
                <div class="stat">
                    ...
                    <div class="stat-value text-blue-500">Coordenador</div>
                    <div class="stat-desc">Responsável por criar a equipe no sistema</div>
                </div>
            </a>
        </div>
        <div class="stats shadow">
            <a wire:click="showGroupModal(3)" class="cursor-pointer">
                <div class="stat">
                    <div class="stat-figure text-blue-500">
                        <svg class="w-8 h-8 " fill="currentColor" version="1.1" id="Capa_1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <div class="stat-value text-blue-500">Treinador</div>
                    <div class="stat-desc">Treinador de equipe</div>
                </div>
            </a>
        </div>
        <div class="stats shadow">
            <a wire:click="showGroupModal(4)" class="cursor-pointer">
                <div class="stat">
                    <div class="stat-figure text-blue-500">
                        <svg class="w-8 h-8 " fill="currentColor" version="1.1" id="Capa_1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <div class="stat-value text-blue-500">Atleta</div>
                    <div class="stat-desc">Atleta das equipes</div>
                </div>
            </a>
        </div>
        <div class="stats shadow">
            <a wire:click="showGroupModal(5)" class="cursor-pointer">
                <div class="stat">
                    <div class="stat-figure text-blue-500">
                        <svg class="w-8 h-8 " fill="currentColor" version="1.1" id="Capa_1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <div class="stat-value text-blue-500">Visitante</div>
                    <div class="stat-desc">Usuário do sistema</div>
                </div>
            </a>
        </div>
    </div>
    {{-- MODAL DELETE --}}
    <x-confirmation-modal wire:model="showGroupModal">
        <x-slot name="title">Perfil de acesso</x-slot>
        <x-slot name="content">
            <h2 class="h2">Tem certeza que escolheu o perfil correto?</h2>
            <p>Não se preocupe, você pode alterar a escolha na sua pagina de perfil!</p>
        </x-slot>
        <x-slot name="footer">
            <button wire:click.prevent="store()" wire.loading.attr='disable'
                class="text-white
            ...
            <x-primary-button wire:click="$toggle('showGroupModal')" class="mx-2">
                Fechar
                </x-secondary-button>
